...
const PricingCard: React.FC<PricingCardProps> = ({ pricing }) => {
  return (
    <div className="">
  <div className="flex flex-col md:flex-row md:justify-center items-stretch py-15 gap-x-12 sm:px-2 pl-9">
    {/* First Card */}
    <div className="w-full max-w-[90%] md:max-w-[30%] bg-white border border-gray-200 rounded-lg shadow-sm p-6 sm:p-8 text-left mt-10 flex flex-col">
      ...
      <ul className="mt-7 flex flex-col text-sm space-y-3 flex-grow">
    ...
    <div className="w-full max-w-[90%] md:max-w-[30%] bg-white border border-gray-200 rounded-lg shadow-sm p-6 sm:p-8 text-left mt-10 flex flex-col">
      ...
      <ul className="mt-7 flex flex-col text-sm space-y-3 flex-grow">
        <li className="flex items-start gap-x-2">
          <CheckCircle className="text-gray-700 flex-shrink-0" />
          <span>Access to over 100 convention Hotels with open dates in the USA</span>
        </li>
        <li className="flex gap-x-2">
          <CheckCircle className="text-gray-700 flex-shrink-0" />
          <span>Real time date availability with all necessary information (available rooms, meeting space and booking incentives)</span>
        </li>
        <li className="flex items-start gap-x-2">
          <CheckCircle className="text-gray-700 flex-shrink-0" />
    ...
    //   {/* First Card */}
    //   <div className="w-full max-w-[90%] md:max-w-[30%] bg-white border border-gray-200 rounded-lg shadow-sm p-6 sm:p-8 text-left   ">
    //     <h1 className="text-4xl font-bold text-red-900">
    //       {pricing || "$450"}
    //       <span className="text-sm text-gray-600 font-normal">
    //         {" "}
